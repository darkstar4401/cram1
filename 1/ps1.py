...
#
mu = np.matrix([[sp500_vol_ann/sp500_vbtix_corr], [vbtix_vol_ann/sp500_vbtix_corr]])
mu
...
#
#
# # TODO: Calculate the weights of the global minimum variance portfolio
...
#
#
# # TODO: Calculate the expected mean of the minimum variance portfolio
# #  Hint: The portfolio return is defined as mu^T * w_p
# #
# mu_mvp    =
#
#
# # TODO: Calculate the expected volatility of the minimum variance portfolio
...
#
#
# # TODO: Calculate the unconstrained efficient frontier (analytical solution)
...
#
#
# # TODO: Find the tangency portfolio among the ones in the efficient frontier
# #  Hint: use the '.argmax()' function to find the maximum value in an array
# #
# sharpe   =             # Calculate the sharpe ratio
# ind      =             # Find the position of the max sharpe ratio
#
# w_tp     = w_ef[ind,]
# mu_tp    = mu_ef[ind]
